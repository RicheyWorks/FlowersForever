...
mvn spring-boot:run
# or
java -jar target/flowerfarm-manager-1.0.12.jar

# CLI
java -jar target/flowerfarm-manager-1.0.12.jar --cli

# SQLite
java -jar target/flowerfarm-manager-1.0.12.jar --spring.profiles.active=sqlite

# Shared barn login (GUI + HTTP Basic)
java -jar target/flowerfarm-manager-1.0.12.jar --spring.profiles.active=auth
...
java -jar target/flowerfarm-manager-1.0.12.jar --spring.profiles.active=demo
# demo + barn auth:
java -jar target/flowerfarm-manager-1.0.12.jar --spring.profiles.active=demo,auth
```
