...
mvn spring-boot:run
# or
java -jar target/flowerfarm-manager-1.0.8.jar

# CLI
java -jar target/flowerfarm-manager-1.0.8.jar --cli

# SQLite
java -jar target/flowerfarm-manager-1.0.8.jar --spring.profiles.active=sqlite
